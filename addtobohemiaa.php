...
function add_to_bohemiaa($data){
	...
	switch ($linktype) {
		case "text":
			...
			break;
		case "image":
			$data=$data."<p class=\"bohemiaa\"><a href=\"javascript:void(0);\" onclick=\"window.open('http://www.bohemiaa.com/index.php?L=users.share&link=".get_permalink($post->ID)."','BohemiaaShare','width=694,height=500');\" ><img src=\"".get_bloginfo(wpurl)."/wp-content/plugins/add-to-bohemiaa-social/addbohemiaa.png\" width=\"48px\" alt=\"Share on Bohemiaa\" title=\"Share on Bohemiaa\" /></a></p>";
			break;
		case "both":
			$data=$data."<p class=\"bohemiaa\"><a href=\"javascript:void(0);\" onclick=\"window.open('http://www.bohemiaa.com/index.php?L=users.share&link=".get_permalink($post->ID)."','BohemiaaShare','width=694,height=500');\" ><img src=\"".get_bloginfo(wpurl)."/wp-content/plugins/add-to-bohemiaa-social/addbohemiaa.png\" width=\"48px\" alt=\"Share on Bohemiaa\" title=\"Share on Bohemiaa\" /></a><a href=\"javascript:void(0);\" onclick=\"window.open('http://www.bohemiaa.com/index.php?L=users.share&link=".get_permalink($post->ID)."','BohemiaaShare','width=694,height=500');\"  title=\"Share on bohemiaa\">Share on Bohemiaa</a></p>";
			break;
		}
		return $data;
}
	...
	if ($insertiontype != 'auto'){
		...
		switch ($linktype) {
			...
			case "image":
				...
				break;
			case "both":
				echo "<p class=\"bohemiaa\"><a href=\"http://www.bohemiaa.com/index.php?L=users.share&link=".get_permalink($post->ID)."\" ><img src=\"".get_bloginfo(wpurl)."/wp-content/plugins/add-to-bohemiaa-social/addbohemiaa.png\" width=\"48px\" alt=\"Share on Bohemiaa\" title=\"Share on Bohemiaa\" /></a><a href=\"javascript:void(0);\" onclick=\"window.open('http://www.bohemiaa.com/index.php?L=users.share&link=".get_permalink($post->ID)."','BohemiaaShare','width=694,height=500');\"  title=\"Share on Bohemiaa\">Share on Bohemiaa</a></p>";
				break;
			}
		}
}
...
function bohemiaacss() {
	?>
	<link rel="stylesheet" href="<?php bloginfo('wpurl'); ?>/wp-content/plugins/add-to-bohemiaa-social/bohemiaa.css" type="text/css" media="screen" />
	<?php
}
